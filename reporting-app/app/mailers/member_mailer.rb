...
class MemberMailer < ApplicationMailer
  after_deliver :maybe_set_verification_window
  ...
  # Open the verification window on the case if
  # 1) This email was generated by a process that should start the window (if
