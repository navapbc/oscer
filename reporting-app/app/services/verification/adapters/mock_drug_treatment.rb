...
module Verification
  module Adapters
    # Mock verification data source demonstrating the dynamic data-source call in
    # ExclusionDeterminationService. It needs no external integration: the outcome
    # is derived purely from the last digit of the member's va_icn.
    #
    #   * absent ICN                          -> :skipped
    ...
    #
    # Outcomes are Determination::REASON_CODE_MAPPING keys (the "emit the key"
    # convention): :drug_treatment -> "drug_treatment_excluded" (exclusion),
    # :was_in_drug_treatment -> "drug_treatment_excepted" (exception).
