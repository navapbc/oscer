...
user = User.first || User.create!(email: "staff@example.com", uid: SecureRandom.uuid, provider: "login.gov", first_name: "John", last_name: "Doe", roles: [ "caseworker" ], program: "Medicaid", region: "Northwest")
