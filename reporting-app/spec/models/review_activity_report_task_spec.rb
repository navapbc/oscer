...
RSpec.describe ReviewActivityReportTask, type: :model do
  ...
  describe "#approval_status" do
    ...
    it "is nil (undecided) by default, distinguishable from approved/denied" do
      task = create(:review_activity_report_task_with_form, case: certification_case)
    ...
    it "records an approved decision" do
      task = create(:review_activity_report_task_with_form, case: certification_case, approval_status: :approved)
    ...
    it "records a denied decision" do
      task = create(:review_activity_report_task_with_form, case: certification_case, approval_status: :denied)
